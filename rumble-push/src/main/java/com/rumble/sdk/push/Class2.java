...
public class Class2 {
    ...
    public Class2() {
        ...
        Spannable message = new SpannableString(String.format("Push-SDK plugged-in successfully"));
...
//    }
    ...
    public void onEvent(String event) {
        Spannable message = new SpannableString(String.format("Push-SDK got message:,'%s' ", event));
